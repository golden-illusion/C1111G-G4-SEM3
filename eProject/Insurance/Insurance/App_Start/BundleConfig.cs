...
namespace Insurance
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/admin/bundles/datatable").Include(
                    "~/Areas/Admin/Scripts/datatable/jquery.dataTables.min.js",
                    "~/Areas/Admin/Scripts/datatable/TableTools.min.js"
                ));
